...
flow:
  ...
  inputs:
    - host: 10.0.46.10
    - username: "CAPA1\\1045-capa1user"
    - password: Automation123
    - datacenter: Capa1 Datacenter
    - image: Ubuntu
    - folder: Students/Hristo
    - prefix_list: '1-,2-,3-'
  workflow:
    - uuid:
        do:
  ...
  graph:
    steps:
      ...
      wait_for_vm_info:
        ...
        y: 147
        navigate:
          a2256b9d-1884-5209-959c-fcc43693af41:
            targetId: 7f277eb6-d797-3316-7aa2-799481d82b02
            port: SUCCESS
    results:
      SUCCESS:
        7f277eb6-d797-3316-7aa2-799481d82b02:
          x: 536
          y: 329
